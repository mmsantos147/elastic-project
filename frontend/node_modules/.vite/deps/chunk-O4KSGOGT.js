...
function useSyncState(defaultValue) {
  var _React$useReducer = React6.useReducer(function(x) {
    return x + 1;
  }, 0), _React$useReducer2 = _slicedToArray(_React$useReducer, 2), forceUpdate = _React$useReducer2[1];
  var currentValueRef = React6.useRef(defaultValue);
...
var useNextFrame_default = function() {
  var nextFrameRef = React8.useRef(null);
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var eventHandlers = React10.useMemo(function() {
  ...
  var visibleRef = (0, import_react5.useRef)(null);
  useIsomorphicLayoutEffect_default(function() {
  ...
  var firstMountChangeRef = React10.useRef(false);
  (0, import_react5.useEffect)(function() {
    if (asyncVisible) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React11.forwardRef(function(props, ref) {
    var _props$visible = props.visible, visible = _props$visible === void 0 ? true : _props$visible, _props$removeOnLeave = props.removeOnLeave, removeOnLeave = _props$removeOnLeave === void 0 ? true : _props$removeOnLeave, forceRender = props.forceRender, children = props.children, motionName = props.motionName, leavedClassName = props.leavedClassName, eventProps = props.eventProps;
    var _React$useContext = React11.useContext(Context), contextMotion = _React$useContext.motion;
    ...
    var renderedRef = React11.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }
    var setNodeRef = React11.useCallback(function(node) {
    ...
    if (React11.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var originNodeRef = getNodeRef(motionChildren);
      if (!originNodeRef) {
        motionChildren = React11.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return React11.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React12.Fragment;
        var motionProps = {};
        ...
        return React12.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded22);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React12.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React13.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React13.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React14.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React15.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const memoIconContextValue = React15.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp,
    layer: layer ? "antd" : void 0
  }), [iconPrefixCls, csp, layer]);
  let childNode = React15.createElement(React15.Fragment, null, React15.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React15.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React15.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React15.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React15.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React15.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React15.createElement(MotionWrapper, null, childNode);
  ...
  if (theme) {
    childNode = React15.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React15.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React15.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React15.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React15.useContext(ConfigContext);
  const antLocale = React15.useContext(context_default);
  return React15.createElement(ProviderChildren, Object.assign({
...
var LayoutContext = React16.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React17.createContext({});
...
var Sider = React17.forwardRef((props, ref) => {
  const {
  ...
  const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React17.createElement("span", {
    onClick: toggle,
  ...
  }, trigger || React17.createElement(BarsOutlined_default, null)) : null;
  const reverseIcon = direction === "rtl" === !reverseArrow;
  const iconObj = {
    expanded: reverseIcon ? React17.createElement(RightOutlined_default, null) : React17.createElement(LeftOutlined_default, null),
    collapsed: reverseIcon ? React17.createElement(LeftOutlined_default, null) : React17.createElement(RightOutlined_default, null)
  };
  const status = collapsed ? "collapsed" : "expanded";
  const defaultTrigger = iconObj[status];
  const triggerDom = trigger !== null ? zeroWidthTrigger || React17.createElement("div", {
  ...
  return wrapCSSVar(React17.createElement(SiderContext.Provider, {
    value: contextValue
  }, React17.createElement("aside", Object.assign({
    className: siderCls
  }, divProps, {
    style: divStyle,
    ref
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React18.forwardRef((props, ref) => React18.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React18.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React18.createElement(TagName, Object.assign({
    className: (0, import_classnames3.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId, cssVarCls),
    ref
  }, others)));
});
var BasicLayout = React18.forwardRef((props, ref) => {
  const {
    direction
  } = React18.useContext(ConfigContext);
  const [siders, setSiders] = React18.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapCSSVar(React18.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React18.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-O4KSGOGT.js.map
